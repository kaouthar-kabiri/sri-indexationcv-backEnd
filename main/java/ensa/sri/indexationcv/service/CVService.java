package ensa.sri.indexationcv.service;

import ensa.sri.indexationcv.entity.CV;
import ensa.sri.indexationcv.entity.CVShort;
import ensa.sri.indexationcv.exceptions.BadFormatException;
import ensa.sri.indexationcv.exceptions.EmptyFileException;
import ensa.sri.indexationcv.exceptions.EmptyKeywordException;
import ensa.sri.indexationcv.exceptions.IdNotFoundException;
import ensa.sri.indexationcv.repository.CVRepository;
import ensa.sri.indexationcv.repository.CVShortRepository;
...
public class CVService {
    ...
    public List<CVShort> queryInContent(String keyword) {
        ...
        if (!keyword.isEmpty()) {
            NativeSearchQuery searchQuery = new NativeSearchQueryBuilder().withQuery(QueryBuilders.matchQuery("attachment.content", keyword)).withSort(SortBuilders.scoreSort().order(SortOrder.DESC)).build();
